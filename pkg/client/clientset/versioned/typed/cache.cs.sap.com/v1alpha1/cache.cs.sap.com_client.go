...
// CacheV1alpha1Client is used to interact with features provided by the cache.cs.sap.com group.
type CacheV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CacheV1alpha1Client) Valkey(namespace string) ValkeyInterface {
	return newValkey(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	gv := cachecssapcomv1alpha1.SchemeGroupVersion
