...
# Bitnami Secure Images Helm chart for Valkey
...
```console
helm install my-release oci://MY-OCI-REGISTRY/valkey
```
...
```console
helm install my-release oci://REGISTRY_NAME/REPOSITORY_NAME/valkey --set "global.imagePullSecrets[0]=SECRET_NAME" -n NAMESPACE
```
...
You can use the `commonConfiguration` parameter to specify the modules to load. For example, to load the Valkey-Search, Valkey-Bloom, Valkey-JSON and Valkey-LDAP modules supported from Valkey, you can set the following:
...
| `primary.podSecurityContext.enabled`                        | Enable Valkey primary pods' Security Context                                                                                                                                                                                      | `true`                   |
...
| `primary.containerSecurityContext.enabled`                  | Enable Valkey primary containers' Security Context                                                                                                                                                                                | `true`                   |
...
| `primary.persistence.existingClaim`                         | Use an existing PVC which must be created manually before bound                                                                                                                                                                   | `""`                     |
...
| `replica.podSecurityContext.enabled`                        | Enable Valkey replicas pods' Security Context                                                                                                                                                                                     | `true`                   |
...
| `replica.containerSecurityContext.enabled`                  | Enable Valkey replicas containers' Security Context                                                                                                                                                                               | `true`                   |
...
| `replica.extraVolumes`                                      | Optionally, specify an extra list of additional volumes for the Valkey replicas pod(s)                                                                                                                                            | `[]`                     |
...
| `sentinel.automateClusterRecovery`                           | Automate cluster recovery in cases where the last replica is not considered a good replica and Sentinel won't automatically fail over to it.                                                                                        | `false`                           |
...
| `sentinel.failoverTimeout`                                   | Timeout for performing the election failover                                                                                                                                                                                        | `180000`                          |
| `sentinel.parallelSyncs`                                     | Number of replicas that can be reconfigured in parallel to use the new primary after the failover                                                                                                                                   | `1`                               |
...
| `sentinel.containerSecurityContext.enabled`                  | Enable Valkey Sentinel containers' Security Context                                                                                                                                                                                 | `true`                            |
...
| `tls.dhParamsFilename`                          | File containing DH params (to support DH-based ciphers)                                                                                     | `""`    |
...
| `metrics.extraArgs`                                         | Extra arguments for Redis(R) Exporter                                                                                                                                                                                             | `{}`                             |
| `metrics.extraEnvVars`                                      | Array with extra environment variables to add to Redis(R) Exporter                                                                                                                                                                | `[]`                             |
| `metrics.containerSecurityContext.enabled`                  | Enable Redis(R) Exporter containers' Security Context                                                                                                                                                                             | `true`                           |
...
| `kubectl.containerSecurityContext.enabled`                  | Enable kubectl containers' Security Context                                                                                                                                                                                                           | `true`                                                             |
